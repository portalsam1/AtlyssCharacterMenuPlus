...
{
    [HarmonyPatch(typeof(CharacterCreationManager), "Awake")] [SuppressMessage("ReSharper", "UnusedMember.Local")] [SuppressMessage("ReSharper", "InconsistentNaming")]
    public class CharacterCreationManagerPatch
    {
        ...
        private static void Postfix()
        {
            ...
            CharacterMenuPlus.Logger.LogInfo("Character Creation Menu has been patched.");
